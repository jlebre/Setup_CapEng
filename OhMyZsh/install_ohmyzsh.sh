...
user_can_sudo() {
  ...
  *com.termux*) return 1 ;;
  ...
  #    â€¢ with privilege: asks for a password immediately.
  #    â€¢ without privilege: exits with error code 1 and prints the message:
...
print_success() {
  ...
  printf '\n'
  printf '%s\n' "â€¢ Follow us on X: $(fmt_link @ohmyzsh https://x.com/ohmyzsh)"
  printf '%s\n' "â€¢ Join our Discord community: $(fmt_link "Discord server" https://discord.gg/ohmyzsh)"
  printf '%s\n' "â€¢ Get stickers, t-shirts, coffee mugs and more: $(fmt_link "CommitGoods Shop" https://commitgoods.com/collections/oh-my-zsh)"
  printf '%s\n' $FMT_RESET
}
